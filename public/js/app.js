...
Vue.component('searchform', __webpack_require__(8));
Vue.component('users', __webpack_require__(11));
var app = new Vue({
  el: '#app'
});
...
var update = __webpack_require__(15)("020c5550", content, false, {});
      ...
      return _c(
        ...
        [
          _c("div", { staticClass: "column" }, [
            ...
            _vm._v(" "),
            _c("p", [_vm._v(_vm._s(user.birthdate))])
          ])
        ]
      )
    })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(15)("305f789b", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
